...
public class VelocityPlugin {
    ...
    public VelocityPlugin(ProxyServer server, Logger logger, String namespace) {
        init(server, logger, namespace);
    }
    ...
    private void init(ProxyServer server, Logger logger, String namespace) {
        setLogger(logger);
        setServer(server);
